...
def main():
    ...
    parser.add_argument("--read_ref_statis", default=False, help="read the statistics for the reference batch")
    ...
    if not args.read_ref_statis:
        print(f"computing reference batch activations {args.ref_batch}...")
        ref_acts = evaluator.read_activations(args.ref_batch)
        np.savez('celeba256_ref_acts_1.npz', ref_acts[0])
        np.savez('celeba256_ref_acts_2.npz', ref_acts[1])
        print(f"reference batch activations saved: celeba256_ref_acts_1.npz and celeba256_ref_acts_2.npz")
    else:
        print(f"loading reference batch activations...")
        ref_acts = (np.load('celeba256_ref_acts_1.npz')['arr_0'],
                    np.load('celeba256_ref_acts_2.npz')['arr_0'])
