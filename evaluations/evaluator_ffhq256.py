...
def main():
    ...
    if not args.read_ref_statis:
        ...
        np.savez('ffhq256_ref_acts_1.npz', ref_acts[0])
        np.savez('ffhq256_ref_acts_2.npz', ref_acts[1])
        print(f"reference batch activations saved: ffhq256_ref_acts_1.npz and ffhq256_ref_acts_2.npz")
    else:
        print(f"loading reference batch activations...")
        ref_acts = (np.load('ffhq256_ref_acts_1.npz')['arr_0'],
                    np.load('ffhq256_ref_acts_2.npz')['arr_0'])
